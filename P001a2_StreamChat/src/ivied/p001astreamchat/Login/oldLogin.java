...
import ivied.p001astreamchat.Core.IrcClient;
 ...
 */
public class oldLogin extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        okay.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        loginSc2 = (ImageButton) findViewById(R.id.btnImageAddLogin);
        ...
        clearSc2tvLogin.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        ...
        clearTwitchLogin.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        clearAllLoigins = (Button) findViewById(R.id.btnClearLogins);
        clearAllLoigins.setOnClickListener(this);
        clearAllLoigins.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        loadLogins();
    ...
    public void savePass(String site, String name, String pass) {
        sPref = getSharedPreferences("Login", 0);
        final String SAVED_NAME = site;
        final String SAVED_PASS = site + "pass";
        Editor ed = sPref.edit();
